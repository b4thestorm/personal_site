...
class LinkedinsControllerTest < ActionController::TestCase
  ...
  test "should create linkedin" do
    assert_difference('Linkedin.count') do
      post :create, linkedin: { education: @linkedin.education, experience: @linkedin.experience, name: @linkedin.name, skills: @linkedin.skills, summary: @linkedin.summary, title: @linkedin.title }
    end
  ...
  test "should update linkedin" do
    patch :update, id: @linkedin, linkedin: { education: @linkedin.education, experience: @linkedin.experience, name: @linkedin.name, skills: @linkedin.skills, summary: @linkedin.summary, title: @linkedin.title }
    assert_redirected_to linkedin_path(assigns(:linkedin))
  end
